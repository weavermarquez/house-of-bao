...
By difficulty:
  1. easy: 30 cases, avg depth=2.3, range=[1-3]
  2. medium: 40 cases, avg depth=3.5, range=[2-4]
  3. hard: 30 cases, avg depth=4.8, range=[3-5]
...
Sample cases:
  lof_001: (()())((())(()))     -> ()     (d=3, 1. easy, 4 steps)
  lof_002: ((()))(((())(()))(())) -> ()     (d=4, 2. medium, 5 steps)
  lof_003: ((()((())(())(())))) -> ()     (d=5, 3. hard, 4 steps)
  lof_004: (())                 -> void   (d=2, 2. medium, 1 steps)
  lof_005: (((())()))           -> ()     (d=4, 2. medium, 2 steps)
#+end_example

...
========================================
Results: 1/15 (6.7%)
  ❌ comp_001 (openai): count=0 (target: 2)
  ✅ comp_001 (anthropic): count=2 (target: 2)
  ❌ comp_001 (google): count=4 (target: 2)
  ❌ comp_002 (openai): count=0 (target: 7)
  ❌ comp_002 (anthropic): count=4 (target: 7)
  ❌ comp_002 (google): count=3 (target: 7)
  ❌ comp_003 (openai): count=0 (target: 5)
  ❌ comp_003 (anthropic): count=8 (target: 5)
  ❌ comp_003 (google): count=4 (target: 5)
  ❌ comp_004 (openai): count=0 (target: 5)
  ❌ comp_004 (anthropic): count=4 (target: 5)
  ❌ comp_004 (google): count=3 (target: 5)
  ❌ comp_005 (openai): count=0 (target: 3)
  ❌ comp_005 (anthropic): count=4 (target: 3)
  ❌ comp_005 (google): count=4 (target: 3)
#+end_example
...
========================================
Results: 3/15 (20.0%)
  💀 comp_001 (openai): count=5 (target: 2)
  🥰 comp_001 (anthropic): count=2 (target: 2)
  🥰 comp_001 (google): count=2 (target: 2)
  💀 comp_002 (openai): count=8 (target: 7)
  💀 comp_002 (anthropic): count=5 (target: 7)
  💀 comp_002 (google): count=5 (target: 7)
  💀 comp_003 (openai): count=4 (target: 5)
  💀 comp_003 (anthropic): count=-1 (target: 5)
  💀 comp_003 (google): count=6 (target: 5)
  💀 comp_004 (openai): count=8 (target: 5)
  💀 comp_004 (anthropic): count=-1 (target: 5)
  🥰 comp_004 (google): count=5 (target: 5)
  💀 comp_005 (openai): count=6 (target: 3)
  💀 comp_005 (anthropic): count=-1 (target: 3)
  💀 comp_005 (google): count=2 (target: 3)

=== Accuracy by Model ===
gpt-5.1: 0.0% (0/5), avg off: 2.2
claude-opus-4-5-20251101: 20.0% (1/5), avg off: 2.0
gemini-3-pro-preview: 40.0% (2/5), avg off: 1.3

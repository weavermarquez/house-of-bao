...
At each step, output an exact line of the form:
STEP k: expr => expr' [I1]  
or
STEP k: expr => expr' [I2]
...
# Test parsing from realistic response
print("\nParsing test:")
sample_response = """
STEP 1: (())(()) => (()) [I1]
STEP 2: (()) => void [I2]
FINAL: void
"""
steps = parse_trace_steps(sample_response)
print(f"  Parsed {len(steps)} steps: {steps}")

validation = validate_trace(sample_response, "(())(())")
...
--- lof_003 (gemini-3-pro-preview) ---
Input: ((((()))(())((()(())(())())())))(((((())))((())((())(())()))((()(()))((())(())(()))(())((())))())())
Expected: (), Got: void
Response:
To simplify the expression using the Laws of Form, we apply the two axioms:
,**I1 (Number):** `()()` = `()`
,**I2 (Order):** `(())` = `void`
...
--- lof_004 (gemini-3-pro-preview) ---
Input: ((((())(()()))(((())(())()(()))(()())((())()))((()(())()))()))
Expected: (), Got: void
Response:
To simplify the expression `((((())(()()))(((())(())()(()))(()())((())()))((()(())()))()))`, I will apply the axioms I1 `()() = ()` and I2 `(()) = void` step by step, working from the deepest nested terms outward.
...
=== Accuracy by Model ===
gpt-5.1: 53.3% (16/30)
claude-opus-4-5-20251101: 63.3% (19/30)
gemini-3-pro-preview: 66.7% (20/30)
...
gpt-5.1: ((((()()(())((((((())(())()())(()()(())(())(()))((())(())(())(()))(()())(()))))(((((())(())(())())(()(())(()))((())()(())()())(()()()()())((())()(())))((()(())()()))(((())()()())((())())((()))))))))))
  Expected: (), Got: void
  Response excerpt: Let’s simplify the expression step by step using only:

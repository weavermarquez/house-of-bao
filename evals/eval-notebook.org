...
#+begin_src python
PROMPT_TEMPLATE = """Looking at this expression that represents a form of distinctions, identify how the structure is encoded as a Laws of Form expression, and then evaluate its value using the two axioms:
...
State your final answer in <answer>X</answer> tags where X is the evaluated value of the expression "()" or "void".
"""
...
COMPOSITE_PROMPT_TEMPLATE = """Looking at each expression that represents a form of distinctions, identify how the structure is encoded as a Laws of Form expression, and then evaluate its value using the two axioms:
...
State your final count in <answer>X</answer> tags where X is a single number (0-{n}), counting the number of expressions that evaluate to ().
"""
...
Results: 11/15 (73.3%)
  ...
  ✓ lof_005 (anthropic): ((()((())()(())(())))((()... → ()
  ✓ lof_005 (google): ((()((())()(())(())))((()... → ()
Quick start ready. Uncomment lines above to run.
#+end_example

...
- For each reduction step:
  ...
  ,* Identify the specific part of the expression being reduced
  ,* Show the complete expression after the transformation
...
**Axiom I1 (Number):** Multiple adjacent empty marks condense into a single mark. 

**Axiom I2 (Order):** A mark containing only another mark cancels to void (nothing).

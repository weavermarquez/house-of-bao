...
Sample cases:
  ...
  lof_003: ((((()))(())((()(())(())())())))(((((())))((())((())(())()))((()(()))((())(())(()))(())((())))())()) -> ()     (d=6, 2. medium, 26 steps)
  lof_004: ((((())(()()))(((())(())()(()))(()())((())()))((()(())()))())) -> ()     (d=6, 2. medium, 16 steps)
  lof_005: ((((()()(())((((((())(())()())(()()(())(())(()))((())(())(())(()))(()())(()))))(((((())(())(())())(()(())(()))((())()(())()())(()()()()())((())()(())))((()(())()()))(((())()()())((())())((())))))))))) -> ()     (d=11, 3. hard, 51 steps)
#+end_example
...
#+RESULTS:
: Saved 30 test cases to test_cases.json
...
2. The second large blo...
#+end_example

* Analyze Sample Results

Run trace validation on the sample results.

#+begin_src python
# Analyze sample results with trace validation
if 'sample_results' in dir() and sample_results:
    ...
    for model, stats in sorted(analysis["by_model"].items()):
        pct = stats["accuracy"] * 100
        trace_pct = stats["avg_trace_score"] * 100
        print(f"{model}: {pct:.1f}% final, {trace_pct:.1f}% trace ({stats['correct']}/{stats['total']})")

    if analysis["error_types"]:
        print("\n=== Trace Error Types ===")
        for model, errors in sorted(analysis["error_types"].items()):
            if errors:
                print(f"\n{model}:")
                for error_type, count in sorted(errors.items(), key=lambda x: -x[1]):
                    print(f"  {error_type}: {count}")

    # Show detailed trace analysis for failures
    failures = [r for r in sample_results if not r["correct"]]
    if failures:
        print(f"\n=== Failure Trace Analysis ({len(failures)} failures) ===")
        for f in failures[:3]:
            print(f"\n{f['model']}: {f['input'][:40]}...")
            print(f"  Expected: {f['target']}, Got: {f['extracted_answer']}")
            if "trace_validation" in f:
                tv = f["trace_validation"]
                print(f"  Trace: {tv['steps_valid']}/{tv['steps_parsed']} steps valid, score={tv['trace_score']:.1%}")
                if tv["errors"]:
                    for step_num, err_type, before, after, axiom in tv["errors"][:2]:
                        print(f"    Step {step_num} ({err_type}): {before[:25]}... [{axiom}]")
else:
    print("No sample_results found. Run the Sample Run cell first.")
#+end_src
...
#+RESULTS:
: Submitting batches for 30 test cases...
:   Submitting Gemini batch...
: Both GOOGLE_API_KEY and GEMINI_API_KEY are set. Using GOOGLE_API_KEY.
:     Gemini batch ID: batches/izt2k94rwktvv4pre8ai2cmkv5ax2yo4htv6
: 
